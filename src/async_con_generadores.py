...
def asyncCount(start, _t):
	if start//1 != start or start <= 0 or _t <= 0:
	...
	for i in range(start, 0, -1):
		...
		while time.time() < t0 + _t: 
			yield        #Cederá constantemente el control de ejecucion mientras no haya transcurrido el tiempo _t desde t0
	print(0)
#------------- Creamos dos generadores como los definidos anteriormente, con diferentes diferentes---------
